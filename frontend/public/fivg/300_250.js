(function (cjs, an) {
  ...
  (lib.Tween35 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics.f('#DDA53B').s().p('Aj6GbIACs1IHzAAIAACEIlXAAIgBDIIEQAAIAACDIkQABIAAFlg');
    this.shape.setTransform(-86.3, 0.2);

    this.shape_1 = new cjs.Shape();
    this.shape_1.graphics.f('#DDA53B').s().p('AhNmZICbAAIAAMzIibAAg');
    this.shape_1.setTransform(-45.3, 0.1);

    this.shape_2 = new cjs.Shape();
    this.shape_2.graphics.f('#DDA53B').s().p('Al6mZICdAAIDfJ8IDdp8ICdAAIkiMyIivAAg');
    this.shape_2.setTransform(7.6, 0.1);
  ...
  p.nominalBounds = new cjs.Rectangle(-111.4, -41.4, 222.8, 82.9);
  ...
  (lib.Tween30 = function (mode, startPosition, loop) {
    ...
    this.shape.setTransform(0, 0, 1.458, 1);

    this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));
  }).prototype = p = new cjs.MovieClip();
  p.nominalBounds = new cjs.Rectangle(-218.7, -300, 437.5, 600);
  ...
  (lib.Tween29 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      .f('#DDA53B')
      .s()
      .p('AgFAFQgDgCAAgDQAAgCADgDQACgCADAAQAEAAACACQADADgBACQABADgDACQgCADgEAAQgDAAgCgDg');
    this.shape.setTransform(185.2, 132);
    ...
    this.shape_1.graphics
      ...
      .s()
      .p(
        'AgaBBQgNgIgGgPQgHgOAAgSIAAgSQAAgTAHgOQAGgPANgIQAMgIAPAAQAXAAAOAMQANAMACAWIgMAAQgFgkgjAAQgSAAgLAOQgMAPAAAaIAAAQQAAAZALAOQAMAPASAAQASAAAKgJQAKgJACgTIAMAAQgDAXgNAMQgOAMgWAAQgPAAgMgIg'
      );
    this.shape_1.setTransform(176.6, 125.6);

    this.shape_2 = new cjs.Shape();
    this.shape_2.graphics.f('#DDA53B').s().p('AgoBHIAAiNIAMAAIAACDIBFAAIAAAKg');
    this.shape_2.setTransform(165.4, 125.6);

    this.shape_3 = new cjs.Shape();
    this.shape_3.graphics.f('#DDA53B').s().p('AgoBHIAAiNIAMAAIAACDIBFAAIAAAKg');
    this.shape_3.setTransform(154.9, 125.6);

    this.shape_4 = new cjs.Shape();
    this.shape_4.graphics.f('#DDA53B').s().p('AgJASQAIgNABgLIAAgQIAKAAIAAANQAAATgMAMg');
    this.shape_4.setTransform(142, 133.1);
    ...
    this.shape_5.setTransform(135.3, 127.4);
    ...
    this.shape_6.graphics
      ...
      .s()
      .p(
        'AgUAwQgKgHgHgLQgFgMAAgPIAAgDQgBgPAGgNQAGgMAKgHQALgHAMAAQASAAAMANQAMANgBAXIAAAGIhKAAIAAACQAAASAKAMQAKAMAPAAQAJAAAIgEQAHgDAFgIIAIAGQgNATgYAAQgNAAgLgHgAgUgiQgIAJgDARIA+AAIAAgCQAAgPgIgJQgIgKgNAAQgMAAgKAKg'
      );
    this.shape_6.setTransform(125.2, 127.4);
    ...
    this.shape_7.graphics
      ...
      .s()
      .p(
        'AgeAoQgMgOAAgZIAAgCQAAgQAFgMQAGgMAKgGQAKgHANAAQASAAALAKQALALABARIgMAAQAAgNgIgHQgJgIgMAAQgOAAgKAMQgIALAAAVIAAACQAAAUAIAMQAKALAPAAQAMAAAIgHQAIgHAAgLIAMAAQAAAKgGAIQgGAIgJAEQgJAFgKAAQgVAAgMgPg'
      );
    this.shape_7.setTransform(114.9, 127.4);

    this.shape_8 = new cjs.Shape();
    this.shape_8.graphics
      .f('#DDA53B')
      .s()
      .p('AgFBIIAAhoIALAAIAABogAgFg5QgCgDAAgDQAAgDACgDQACgCADAAQAEAAACACQACADAAADQAAADgCADQgCABgEAAQgDAAgCgBg');
    this.shape_8.setTransform(107.5, 125.5);

    this.shape_9 = new cjs.Shape();
    this.shape_9.graphics.f('#DDA53B').s().p('AgDA1IgphpIAMAAIAgBZIAhhZIALAAIgnBpg');
    this.shape_9.setTransform(100.4, 127.4);

    this.shape_10 = new cjs.Shape();
    this.shape_10.graphics.f('#DDA53B').s().p('AgYA2IAAhpIAMAAIAAARQAJgTAUAAIAIABIgBALIgIgBQgLAAgGAHQgIAGgDALIAABIg');
    this.shape_10.setTransform(92.9, 127.3);
    ...
    this.shape_11.graphics
      ...
      .s()
      .p(
        'AgTAwQgMgHgGgLQgFgMgBgPIAAgDQAAgPAGgNQAGgMALgHQAKgHALAAQAUAAALANQALANAAAXIAAAGIhKAAIAAACQAAASALAMQAKAMAOAAQAKAAAGgEQAIgDAGgIIAHAGQgNATgYAAQgNAAgKgHgAgTgiQgKAJgBARIA+AAIAAgCQgBgPgIgJQgIgKgOAAQgLAAgJAKg'
      );
    this.shape_11.setTransform(83.9, 127.4);
    ...
    this.shape_12.graphics
      ...
      .s()
      .p(
        ''
      );
    this.shape_12.setTransform(72.8, 125.6);
    ...
    this.shape_13.graphics
      ...
      .s()
      .p(
        'AgeA9QgLgPAAgYIAAgCQAAgXALgPQALgPASAAQAVAAALARIAAg7IALAAIAACVIgKAAIgBgOQgLAQgVAAQgSAAgLgPgAgVgLQgJALAAAWQAAAVAJALQAHAMAOAAQAWAAAJgTIAAgxQgJgUgWAAQgNgBgIAMg'
      );
    this.shape_13.setTransform(56.2, 125.3);
    ...
    this.shape_14.graphics
      ...
      .s()
      .p(
        'AAcA2IAAhFQAAgOgGgHQgGgHgNAAQgJAAgJAHQgIAHgEALIAABIIgMAAIAAhpIAMAAIAAASQAGgKAIgFQAJgFAKAAQARAAAIAKQAJAJAAATIAABFg'
      );
    this.shape_14.setTransform(45.4, 127.3);
    ...
    this.shape_15.setTransform(34.4, 127.5);

    this.shape_16 = new cjs.Shape();
    this.shape_16.graphics.f('#DDA53B').s().p('AgrBHIAAiNIBXAAIAAAKIhLAAIAAA4IBCAAIAAAIIhCAAIAABDg');
    this.shape_16.setTransform(23.9, 125.6);
    ...
    this.shape_17.setTransform(7.8, 127.4);
    ...
    this.shape_18.setTransform(-3.2, 125.3);
    ...
    this.shape_19.graphics
      ...
      .s()
      .p('AgFBIIAAhoIALAAIAABogAgFg5QgCgDAAgDQAAgDACgDQACgCADAAQAEAAACACQACADAAADQAAADgCADQgCABgEAAQgDAAgCgBg');
    this.shape_19.setTransform(-10.7, 125.5);
    ...
    this.shape_20.setTransform(-18.1, 127.4);
    ...
    this.shape_21.graphics
      ...
      .s()
      .p(
        'AgUAwQgKgHgGgLQgHgMABgPIAAgDQAAgPAFgNQAGgMAKgHQALgHAMAAQASAAAMANQAMANAAAXIAAAGIhLAAIAAACQAAASAKAMQALAMAOAAQAJAAAHgEQAIgDAFgIIAIAGQgNATgZAAQgMAAgLgHgAgUgiQgIAJgDARIA+AAIAAgCQAAgPgIgJQgIgKgNAAQgMAAgKAKg'
      );
    this.shape_21.setTransform(-28.1, 127.4);

    this.shape_22 = new cjs.Shape();
    this.shape_22.graphics.f('#DDA53B').s().p('AgYA2IAAhpIAMAAIAAARQAJgTAUAAIAIABIgBALIgIgBQgLAAgGAHQgIAGgDALIAABIg');
    this.shape_22.setTransform(-36.1, 127.3);
    ...
    this.shape_23.setTransform(-45.7, 127.4);

    this.shape_24 = new cjs.Shape();
    this.shape_24.graphics.f('#DDA53B').s().p('AgrBHIAAiNIBXAAIAAAKIhLAAIAAA4IBBAAIAAAIIhBAAIAABDg');
    this.shape_24.setTransform(-56.3, 125.6);

    this.shape_25 = new cjs.Shape();
    this.shape_25.graphics
      .f('#DDA53B')
      .s()
      .p('AglBJIAAgKIAFAAQAJAAAGgEQAEgEAFgKIAEgOIgnhoIAMAAIAgBXIAfhXIANAAIgtB7IgCAFQgJATgRAAIgJgBg');
    this.shape_25.setTransform(-72.1, 129.5);
    ...
    this.shape_26.graphics
      ...
      .s()
      .p(
        'AgeA8IgBAOIgLAAIAAiVIAMAAIAAA7QALgRAVAAQATAAALAOQALAPAAAYIAAACQAAAZgLAOQgLAPgTAAQgVAAgLgQgAgSgRQgIAGgEAKIAAAvQAJAUAVAAQAPAAAIgMQAIgLAAgXQAAgUgIgLQgIgMgPABQgKgBgIAGg'
      );
    this.shape_26.setTransform(-82.2, 125.3);
    ...
    this.shape_27.graphics
      ...
      .s()
      .p(
        'AgeA9QgMgPAAgYIAAgCQABgXAKgPQALgPAUAAQAUAAALARIAAg7IAMAAIAACVIgMAAIAAgOQgLAQgVAAQgSAAgLgPgAgWgLQgHALAAAWQAAAVAHALQAJAMANAAQAWAAAJgTIAAgxQgJgUgWAAQgNgBgJAMg'
      );
    this.shape_27.setTransform(-98.6, 125.3);
    ...
    this.shape_28.graphics
      ...
      .s()
      .p(
        'AgTAwQgMgHgFgLQgHgMAAgPIAAgDQABgPAFgNQAGgMALgHQAKgHALAAQAUAAALANQAMANAAAXIAAAGIhLAAIAAACQAAASALAMQAJAMAPAAQAKAAAGgEQAIgDAGgIIAHAGQgNATgZAAQgMAAgKgHgAgTgiQgJAJgDARIA+AAIAAgCQAAgPgIgJQgIgKgOAAQgMAAgIAKg'
      );
    this.shape_28.setTransform(-108.9, 127.4);
    ...
    this.shape_29.graphics
      ...
      .s()
      .p(
        'AgCA8QgFgHAAgNIAAhGIgUAAIAAgJIAUAAIAAgbIALAAIAAAbIAWAAIAAAJIgWAAIAABGQAAAIADAFQADAEAHAAIAKgBIAAAKQgEABgIAAQgMAAgFgHg'
      );
    this.shape_29.setTransform(-117.6, 126.1);
    ...
    this.shape_30.graphics
      ...
      .s()
      .p('AgeAsQgJgKAAgTIAAhEIAMAAIAABCQAAAfAYAAQAZAAAGgVIAAhMIAMAAIAABpIgLAAIgBgOQgKAQgWAAQgRAAgJgKg');
    this.shape_30.setTransform(-126.1, 127.5);
    ...
    this.shape_31.setTransform(-136.8, 125.3);

    this.shape_32 = new cjs.Shape();
    this.shape_32.graphics
      .f('#DDA53B')
      .s()
      .p('AgFBIIAAhoIALAAIAABogAgFg5QgCgDAAgDQAAgDACgDQADgCACAAQAEAAACACQACADAAADQAAADgCADQgCABgEAAQgCAAgDgBg');
    this.shape_32.setTransform(-144.8, 125.5);

    this.shape_33 = new cjs.Shape();
    this.shape_33.graphics.f('#DDA53B').s().p('AgYA2IAAhpIAMAAIAAARQAJgTAUAAIAIABIgBALIgIgBQgLAAgGAHQgIAGgDALIAABIg');
    this.shape_33.setTransform(-149.8, 127.3);
    ...
    this.shape_34.graphics
      ...
      .s()
      .p(
        'AgBA8QgGgHAAgNIAAhGIgTAAIAAgJIATAAIAAgbIALAAIAAAbIAWAAIAAAJIgWAAIAABGQAAAIADAFQADAEAIAAIAJgBIABAKQgFABgIAAQgMAAgEgHg'
      );
    this.shape_34.setTransform(-157.2, 126.1);
    ...
    this.shape_35.setTransform(-165.2, 127.4);
    ...
    this.shape_36.graphics
      ...
      .s()
      .p('AgFBIIAAhoIALAAIAABogAgFg5QgCgDAAgDQAAgDACgDQACgCADAAQAEAAACACQACADAAADQAAADgCADQgCABgEAAQgDAAgCgBg');
    this.shape_36.setTransform(-172.4, 125.5);
    ...
    this.shape_37.graphics
      ...
      .s()
      .p(
        'AgxBHIAAiNIAnAAQARAAAOAIQAOAIAHAOQAIAPAAAUIAAALQAAAUgIAOQgHAPgOAIQgOAIgRAAgAglA9IAbAAQAVAAAOgPQANgPAAgaIAAgLQAAgZgNgOQgNgPgVAAIgcAAg'
      );
    this.shape_37.setTransform(-180.9, 125.6);

    this.shape_38 = new cjs.Shape();
    this.shape_38.graphics
      .f('#DDA53B')
      .s()
      .p('AgFAFQgCgCgBgDQABgDACgCQACgCADAAQAEAAACACQADACgBADQABADgDACQgCADgEAAQgDAAgCgDg');
    this.shape_38.setTransform(106.4, 102.5);
    ...
    this.shape_39.graphics
      ...
      .s()
      .p(
        'AgTAwQgMgHgFgLQgHgMAAgPIAAgDQABgPAFgNQAGgMALgHQAKgHALAAQAUAAALANQAMANAAAXIAAAGIhLAAIAAACQAAASALAMQAJAMAPAAQAKAAAGgEQAIgDAGgIIAHAGQgNATgZAAQgMAAgKgHgAgTgiQgKAJgBARIA+AAIAAgCQgBgPgIgJQgIgKgOAAQgMAAgIAKg'
      );
    this.shape_39.setTransform(99.1, 97.9);

    this.shape_40 = new cjs.Shape();
    this.shape_40.graphics.f('#DDA53B').s().p('AgFBLIAAiVIALAAIAACVg');
    this.shape_40.setTransform(91.6, 95.7);
    ...
    this.shape_41.graphics
      ...
      .s()
      .p(
        'AgeA8IgBAOIgLAAIAAiVIAMAAIAAA7QALgQAVgBQATABALAOQALAOAAAYIAAACQAAAZgLAPQgLAOgTAAQgVAAgLgQgAgSgRQgIAFgEALIAAAvQAJAUAVAAQAPAAAIgMQAIgLAAgXQAAgUgIgLQgIgMgPAAQgKAAgIAGg'
      );
    this.shape_41.setTransform(84.1, 95.8);

    this.shape_42 = new cjs.Shape();
    this.shape_42.graphics
      .f('#DDA53B')
      .s()
      .p('AgFBIIAAhpIALAAIAABpgAgFg5QgCgDAAgDQAAgEACgCQACgCADAAQAEAAACACQACACAAAEQAAADgCADQgCACgEAAQgDAAgCgCg');
    this.shape_42.setTransform(76.1, 96);
    ...
    this.shape_43.setTransform(68.8, 97.9);
    ...
    this.shape_44.graphics
      ...
      .s()
      .p(
        'AgcAuQgLgJAAgOIALAAQABAKAJAGQAHAGAMAAQAMAAAIgGQAIgFgBgIQAAgJgGgFQgIgFgOgDQgNgDgHgDQgIgEgEgGQgDgFgBgIQAAgNALgIQALgIAOAAQATAAAKAJQALAJAAAOIgMAAQAAgKgIgGQgIgGgMAAQgKAAgHAFQgHAFAAAJQAAAHAGAFQAGAEAOAEQAQADAHADQAIAFADAFQAEAGAAAIQAAAOgLAIQgKAIgSAAQgRAAgMgJg'
      );
    this.shape_44.setTransform(58.7, 97.9);
    ...
    this.shape_45.graphics
      ...
      .s()
      .p(
        'AghAoQgNgPAAgYIAAgCQAAgPAGgMQAFgMAMgHQAKgHANAAQAVAAANAPQANAPAAAYIAAACQAAAPgFAMQgGAMgMAHQgKAHgOAAQgUAAgNgPgAgYggQgLANAAATIAAACQAAATALAMQAJAMAPAAQAQAAAJgMQAKgMAAgUIAAgCQABgMgFgKQgEgKgJgFQgHgGgLAAQgPAAgJAMg'
      );
    this.shape_45.setTransform(48.1, 97.9);
    ...
    this.shape_46.graphics
      ...
      .s()
      .p(
        'AgpBKIAAiRIALAAIAAAPQALgRAVAAQATAAALAOQAKAOAAAaIAAACQAAAYgKAOQgLAPgSAAQgVAAgLgQIAAA2gAgSg6QgIAFgDAKIAAAyQAEAJAHAFQAIAEAKABQAPAAAIgMQAIgMAAgVQAAgUgIgMQgJgMgOAAQgKAAgIAFg'
      );
    this.shape_46.setTransform(37.2, 99.9);
    ...
    this.shape_47.graphics
      ...
      .s()
      .p(
        'AgbAuQgMgJAAgOIAMAAQAAAKAJAGQAHAGANAAQALAAAIgGQAHgFAAgIQABgJgIgFQgGgFgOgDQgNgDgJgDQgHgEgEgGQgEgFABgIQAAgNAKgIQALgIAPAAQARAAALAJQAKAJAAAOIgLAAQAAgKgIgGQgHgGgMAAQgLAAgHAFQgHAFAAAJQAAAHAGAFQAFAEAPAEQAQADAHADQAIAFAEAFQADAGAAAIQAAAOgLAIQgLAIgQAAQgSAAgLgJg'
      );
    this.shape_47.setTransform(21.5, 97.9);

    this.shape_48 = new cjs.Shape();
    this.shape_48.graphics
      .f('#DDA53B')
      .s()
      .p('AgFBIIAAhpIALAAIAABpgAgFg5QgCgDAAgDQAAgEACgCQADgCACAAQAEAAACACQACACAAAEQAAADgCADQgCACgEAAQgCAAgDgCg');
    this.shape_48.setTransform(14.3, 96);
    ...
    this.shape_49.setTransform(2.1, 97.9);
    ...
    this.shape_50.setTransform(-8, 97.9);
    ...
    this.shape_51.graphics
      ...
      .s()
      .p(
        'AghAoQgNgPAAgYIAAgCQAAgPAGgMQAFgMAMgHQAKgHANAAQAVAAANAPQANAPAAAYIAAACQAAAPgFAMQgHAMgLAHQgKAHgOAAQgUAAgNgPgAgZggQgJANgBATIAAACQABATAJAMQAKAMAPAAQAQAAAJgMQALgMgBgUIAAgCQABgMgFgKQgEgKgJgFQgHgGgLAAQgPAAgKAMg'
      );
    this.shape_51.setTransform(-18.6, 97.9);

    this.shape_52 = new cjs.Shape();
    this.shape_52.graphics.f('#DDA53B').s().p('AgFBLIAAiVIALAAIAACVg');
    this.shape_52.setTransform(-26.4, 95.7);

    this.shape_53 = new cjs.Shape();
    this.shape_53.graphics.f('#DDA53B').s().p('AgFBLIAAiVIALAAIAACVg');
    this.shape_53.setTransform(-35.7, 95.7);
    ...
    this.shape_54.setTransform(-43.5, 97.9);
    ...
    this.shape_55.graphics
      ...
      .s()
      .p(
        'AgpBKIAAiRIAKAAIABAPQALgRAVAAQATAAALAOQAKAOAAAaIAAACQAAAYgKAOQgLAPgSAAQgVAAgMgQIAAA2gAgSg6QgIAFgEAKIAAAyQAEAJAIAFQAIAEAKABQAPAAAIgMQAIgMAAgVQAAgUgJgMQgHgMgPAAQgKAAgIAFg'
      );
    this.shape_55.setTransform(-54, 99.9);
    ...
    this.shape_56.graphics
      ...
      .s()
      .p('AgFBIIAAhpIALAAIAABpgAgFg5QgCgDAAgDQAAgEACgCQACgCADAAQAEAAACACQACACAAAEQAAADgCADQgCACgEAAQgDAAgCgCg');
    this.shape_56.setTransform(-61.9, 96);
    ...
    this.shape_57.graphics
      ...
      .s()
      .p(
        'AgeAoQgMgOAAgZIAAgCQAAgQAFgMQAGgMAKgGQALgHAMAAQASAAALAKQALALABARIgMAAQAAgNgIgHQgJgIgMAAQgOAAgKAMQgIALAAAVIAAACQAAAUAIAMQAKALAPAAQAMAAAIgHQAIgHAAgLIAMAAQAAAKgGAIQgFAIgKAEQgJAFgKAAQgVAAgMgPg'
      );
    this.shape_57.setTransform(-69.3, 97.9);
    ...
    this.shape_58.graphics
      ...
      .s()
      .p(
        'AAcA2IAAhFQAAgOgFgHQgHgHgMAAQgKAAgJAHQgIAHgEALIAABIIgMAAIAAhpIALAAIABASQAFgKAKgFQAJgFAJAAQARAAAJAKQAIAJAAATIAABFg'
      );
    this.shape_58.setTransform(-79.9, 97.8);
    ...
    this.shape_61.graphics
      ...
      .s()
      .p(
        'AgvBHIAAiNIAvAAQAWAAANALQANAMAAATQAAAVgMAKQgNAKgXAAIgjAAIAAA6gAgjADIAjAAQASAAAJgHQAJgJAAgPQAAgOgJgJQgJgJgRAAIgkAAg'
      );
    this.shape_61.setTransform(-102.3, 96.1);

    this.shape_62 = new cjs.Shape();
    this.shape_62.graphics
      .f('#DDA53B')
      .s()
      .p('AgFAGQgCgCgBgEQABgDACgCQACgCADAAQAEAAACACQADACgBADQABAEgDACQgCACgEAAQgDAAgCgCg');
    this.shape_62.setTransform(95.1, 73.1);

    this.shape_63 = new cjs.Shape();
    this.shape_63.graphics.f('#DDA53B').s().p('AAbBLIgqg1IgNAMIAAApIgMAAIAAiVIAMAAIAABfIALgMIAognIAOAAIgsAsIAwA9g');
    this.shape_63.setTransform(88.7, 66.3);
    ...
    this.shape_64.setTransform(78, 68.5);

    this.shape_65 = new cjs.Shape();
    this.shape_65.graphics
      .f('#DDA53B')
      .s()
      .p('AgFBIIAAhpIALAAIAABpgAgFg6QgCgCAAgDQAAgDACgDQACgCADAAQAEAAACACQACADAAADQAAADgCACQgCADgEAAQgDAAgCgDg');
    this.shape_65.setTransform(70.8, 66.6);

    this.shape_66 = new cjs.Shape();
    this.shape_66.graphics.f('#DDA53B').s().p('AgYA2IAAhpIAMAAIAAARQAJgTAUAAIAIABIgBALIgIgBQgLAAgGAHQgIAGgDALIAABIg');
    this.shape_66.setTransform(65.8, 68.4);
    ...
    this.shape_67.setTransform(51.9, 68.5);
    ...
    this.shape_68.graphics
      ...
      .s()
      .p(
        'AgUAwQgLgHgGgLQgFgMAAgPIAAgDQgBgPAGgNQAGgMAKgHQALgHAMAAQASAAAMANQALANAAAXIAAAGIhKAAIAAACQAAASAKAMQALAMAOAAQAJAAAIgEQAHgDAFgIIAIAGQgNATgYAAQgNAAgLgHgAgUgiQgIAJgCARIA9AAIAAgCQAAgPgIgJQgIgKgNAAQgMAAgKAKg'
      );
    this.shape_68.setTransform(41.9, 68.5);

    this.shape_69 = new cjs.Shape();
    this.shape_69.graphics.f('#DDA53B').s().p('AgEA1IgnhpIALAAIAgBZIAghZIANAAIgoBpg');
    this.shape_69.setTransform(31.8, 68.5);

    this.shape_70 = new cjs.Shape();
    this.shape_70.graphics.f('#DDA53B').s().p('AgFBLIAAiVIALAAIAACVg');
    this.shape_70.setTransform(24.8, 66.3);
    ...
    this.shape_73.setTransform(-3.7, 68.4);

    this.shape_74 = new cjs.Shape();
    this.shape_74.graphics
      .f('#DDA53B')
      .s()
      .p('AgFBIIAAhpIALAAIAABpgAgFg6QgCgCAAgDQAAgDACgDQADgCACAAQAEAAACACQACADAAADQAAADgCACQgCADgEAAQgCAAgDgDg');
    this.shape_74.setTransform(-11.4, 66.6);
    ...
    this.shape_75.setTransform(-24.2, 70.5);
    ...
    this.shape_76.setTransform(-35, 68.4);
    ...
    this.shape_77.graphics
      ...
      .s()
      .p('AgFBIIAAhpIALAAIAABpgAgFg6QgCgCAAgDQAAgDACgDQACgCADAAQAEAAACACQACADAAADQAAADgCACQgCADgEAAQgDAAgCgDg');
    this.shape_77.setTransform(-42.7, 66.6);
    ...
    this.shape_78.setTransform(-48.4, 67.2);
    ...
    this.shape_79.setTransform(-56.4, 68.5);
    ...
    this.shape_82.setTransform(-86.8, 68.4);

    this.shape_83 = new cjs.Shape();
    this.shape_83.graphics.f('#DDA53B').s().p('AgFBHIAAiNIALAAIAACNg');
    this.shape_83.setTransform(-94.9, 66.7);
  ...
  p.nominalBounds = new cjs.Rectangle(-189.8, 53.2, 379.6, 86.4);
  ...
  (lib.Tween24 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        'ACIEhIheg2IAAnVIBeg2IDoAAIBeA2IAAB1IhyAAIAAhKIjAAAIAAF9IDAAAIAAhqIhfAAIAAhfIDRAAIAAD2IheA2gAlvEhIheg2IAAh1IByAAIAABIICnAAIAAirIkHAAIAAkvIFxAAIAABhIkBAAIAABuICrAAIBfA2IAAECIhfA2g'
      );
  ...
  (lib.Tween23 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        'AEEEdIAAo5IFdAAIAABhIjqAAIAACDIC6AAIAABiIi6AAIAADzgAhKEdIAAnYIicAAIAAhhIGmAAIAABhIibAAIAAHYgApgEdIAAo5IFWAAIAABhIjjAAIAACDICyAAIAABiIiyAAIAACSIDjAAIAABhg'
      );
  ...
  (lib.Tween16 = function (mode, startPosition, loop) {
    ...
    this.shape = new cjs.Shape();
    this.shape.graphics
      .lf(['rgba(16,22,35,0)', '#101623', '#101623'], [0, 0.482, 1], 304.1, 0.2, -303.7, 0.2)
      .s()
      .p('EgveAu4MAAAhdvMBe9AAAMAAABdvg');

    this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));
  }).prototype = p = new cjs.MovieClip();
  p.nominalBounds = new cjs.Rectangle(-303.9, -300, 607.8, 600);
  ...
  (lib.Tween1 = function (mode, startPosition, loop) {
    ...
    this.instance.setTransform(-170, -348, 1.133, 1.16);

    this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));
  }).prototype = p = new cjs.MovieClip();
  p.nominalBounds = new cjs.Rectangle(-170, -348, 340, 696);
  ...
  (lib.Symbol22 = function (mode, startPosition, loop) {
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));
  }).prototype = getMCSymbolPrototype(lib.Symbol22, new cjs.Rectangle(0, 0, 300, 313), null);
  ...
  p.nominalBounds = new cjs.Rectangle(-150, -469.5, 300, 939);
  ...
  (lib.Symbol54 = function (mode, startPosition, loop) {
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance).wait(932).to({ _off: false }, 0).to({ y: 305.2 }, 30, cjs.Ease.get(-1)).wait(1)
    );
  }).prototype = p = new cjs.MovieClip();
  p.nominalBounds = null;
  ...
  (lib.Symbol42 = function (mode, startPosition, loop) {
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance)
        ...
        .to({ _off: false }, 0)
        .to({ x: -453.9 }, 20)
        .to({ startPosition: 0 }, 119)
        .to({ rotation: 180, x: 454 }, 1)
        .to({ x: -153.9 }, 18, cjs.Ease.get(-1))
        .to({ _off: true }, 1)
        .wait(168)
        .to({ _off: false, x: 454 }, 0)
        .to({ x: -153.9 }, 26, cjs.Ease.get(-1))
        .to({ regX: 0.1, regY: -0.1, scaleX: 1.99, scaleY: 0.58, rotation: 90, x: -22.9, y: 305.2 }, 1)
        .to({ regY: 0, scaleY: 0.58, x: -23.4, y: -911.1 }, 74)
        .wait(446)
    );
  }).prototype = p = new cjs.MovieClip();
  p.nominalBounds = null;
  ...
  (lib.Symbol41 = function (mode, startPosition, loop) {
    ...
    var mask = new cjs.Shape();
    mask._off = true;
    var mask_graphics_699 = new cjs.Graphics().p(
      'AIFFSIgCqjICFhMIFKAAICFBMIABChIiaAAIgBhqIkeAAIABI0IEfAAIAAikIiIAAIAAiCIEigBIABFdIiFBOIlLAAgAxZGdIACs1IH0AAIAACEIlYAAIAADIIEQAAIAACEIkQAAIgBFlgAoSmYICcAAIABMzIidABgAkvmYICeAAIDfJ7IDdp7ICdAAIkiMyIivAAg'
    );
    ...
    this.timeline.addTween(
      cjs.Tween.get(mask)
        ...
        .wait(699)
        .to({ graphics: mask_graphics_699, x: -0.7, y: -61.2 })
        .wait(363)
    );
    ...
    this.instance.parent = this;
    this.instance.setTransform(-234.4, -69.3, 1.688, 2.064, 0, 39.9, 0, 55.5, 38.4);
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance)
        .wait(699)
        .to({ _off: false }, 0)
        .to({ x: 230.7, y: -47 }, 99, cjs.Ease.get(-1))
        .to({ _off: true }, 1)
        .wait(263)
    );
    ...
    this.instance_1.parent = this;
    this.instance_1.setTransform(-0.7, -61.2);
    this.instance_1.alpha = 0;
    ...
    this.instance_2.parent = this;
    this.instance_2.setTransform(-1.3, -3.1, 0.75, 0.75);
    this.instance_2.alpha = 0;

    this.timeline.addTween(
      cjs.Tween.get(this.instance_2)
        .to({ scaleX: 1, scaleY: 1, x: -1.7, alpha: 1, startPosition: 89 }, 89, cjs.Ease.get(1))
        .to({ y: -66.1, startPosition: 99 }, 158, cjs.Ease.quadInOut)
        .to({ startPosition: 99 }, 399)
    ...
    this.instance_3.parent = this;
    this.instance_3.setTransform(-1.5, -11.7);
    this.instance_3.alpha = 0;

    this.timeline.addTween(
      cjs.Tween.get(this.instance_3)
        .to({ alpha: 1 }, 89, cjs.Ease.get(-1))
        .to({ y: -71.7 }, 158, cjs.Ease.quadInOut)
        .to({ startPosition: 0 }, 399)
        .to({ scaleX: 0.1, scaleY: 0.1, alpha: 0 }, 50, cjs.Ease.get(-1))
        .to({ _off: true }, 1)
        .wait(365)
    );
  }).prototype = p = new cjs.MovieClip();
  p.nominalBounds = new cjs.Rectangle(-177.9, -188.1, 352.9, 352.9);
  ...
  (lib.Symbol33 = function (mode, startPosition, loop) {
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance).wait(89).to({ _off: false }, 0).to({ y: 48 }, 158).to({ _off: true }, 1).wait(652)
    );
  }).prototype = p = new cjs.MovieClip();
  p.nominalBounds = null;
  ...
  p.nominalBounds = new cjs.Rectangle(-68.7, 0, 437.5, 600);
  ...
  (lib.Symbol28 = function (mode, startPosition, loop) {
    ...
    this.shape_2 = new cjs.Shape();
    this.shape_2.graphics.f('rgba(17,22,35,0.898)').s().p('A3lCHIAAkNMAvLAAAIAAENg');
    this.shape_2.setTransform(151, 587.4);
  ...
  p.nominalBounds = new cjs.Rectangle(0, -313, 300, 939);
  ...
  (lib.Symbol19 = function (mode, startPosition, loop) {
    ...
    mask.setTransform(163.1, 314.5);

    // Earth.jpg
    this.instance = new lib.Earthjpgcopy();
    this.instance.parent = this;
    this.instance.setTransform(-122, 0, 1.9, 1.034);
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_1).to({ y: 112.2, alpha: 1 }, 59).wait(121));
  }).prototype = p = new cjs.MovieClip();
  ...
  (lib.Symbol50 = function (mode, startPosition, loop) {
    ...
    this.shape = new cjs.Shape();
    this.shape.graphics.f('#993399').s().p('EghFAteMAAAha7MBCLAAAMAAABa7g');
    this.shape.setTransform(124.2, -226.4);
  ...
  (lib.Symbol25 = function (mode, startPosition, loop) {
    ...
    this.instance.parent = this;
    this.instance.setTransform(176.6, -22.5, 0.578, 0.578, 0, 0, 0, 15.8, 15.6);

    this.instance_1 = new lib.Symbol62('synched', 0);
    this.instance_1.parent = this;
    this.instance_1.setTransform(177.6, -21.3, 0.578, 0.578, 0, 0, 0, 17.6, 17.4);

    this.instance_2 = new lib.Symbol('synched', 0);
    this.instance_2.parent = this;
    this.instance_2.setTransform(-32.6, 35.6, 0.9, 0.9, 0, 0, 0, 37.5, 37.5);

    this.instance_3 = new lib.Symbol61('synched', 0);
    this.instance_3.parent = this;
    this.instance_3.setTransform(-54.3, 14.2, 0.9, 0.9, 0, 0, 0, 13.7, 13.8);
  ...
  p.nominalBounds = new cjs.Rectangle(-498.3, -204.4, 405.7, 164.7);
  ...
  (lib.Symbol60 = function (mode, startPosition, loop) {
    ...
    var mask = new cjs.Shape();
    mask._off = true;
    var mask_graphics_247 = new cjs.Graphics().p('ArLAAILLrLILMLLIrMLMg');
    var mask_graphics_248 = new cjs.Graphics().p('AsyAAIMysyIMzMyIszMzg');
    var mask_graphics_249 = new cjs.Graphics().p('AuXAAIOXuXIOYOXIuYOYg');
    var mask_graphics_250 = new cjs.Graphics().p('Av7AAIP7v7IP8P7Iv8P8g');
    var mask_graphics_251 = new cjs.Graphics().p('AxeAAIRexeIRfReIxfRfg');
    var mask_graphics_252 = new cjs.Graphics().p('AzAAAITAzAITBTAIzBTBg');
    var mask_graphics_253 = new cjs.Graphics().p('A0hAAIUh0hIUiUhI0iUig');
    var mask_graphics_254 = new cjs.Graphics().p('A2BAAIWB2BIWCWBI2CWCg');
    var mask_graphics_255 = new cjs.Graphics().p('A3gAAIXg3gIXhXgI3hXhg');
    var mask_graphics_256 = new cjs.Graphics().p('A49AAIY949IY+Y9I4+Y+g');
    var mask_graphics_257 = new cjs.Graphics().p('A6aAAIaa6aIabaaI6babg');
    var mask_graphics_258 = new cjs.Graphics().p('A71AAIb171Ib2b1I72b2g');
    var mask_graphics_259 = new cjs.Graphics().p('A9PAAIdP9PIdQdPI9QdQg');
    var mask_graphics_260 = new cjs.Graphics().p('A+oAAIeo+oIepeoI+pepg');
    var mask_graphics_261 = new cjs.Graphics().p('EggAAAAMAgAggAMAgBAgAMggBAgBg');
    var mask_graphics_262 = new cjs.Graphics().p('EghXAAAMAhXghXMAhYAhXMghYAhYg');
    var mask_graphics_263 = new cjs.Graphics().p('EgitAAAMAitgitMAiuAitMgiuAiug');
    var mask_graphics_264 = new cjs.Graphics().p('EgkBAAAMAkBgkBMAkCAkBMgkCAkCg');
    var mask_graphics_265 = new cjs.Graphics().p('EglVAAAMAlVglVMAlWAlVMglWAlWg');
    var mask_graphics_266 = new cjs.Graphics().p('EgmnAAAMAmngmnMAmoAmnMgmoAmog');
    var mask_graphics_267 = new cjs.Graphics().p('Egn4AAAMAn4gn4MAn5An4Mgn5An5g');
    var mask_graphics_268 = new cjs.Graphics().p('EgpJAAAMApJgpJMApKApJMgpKApKg');
    var mask_graphics_269 = new cjs.Graphics().p('EgqYAAAMAqYgqYMAqZAqYMgqZAqZg');
    var mask_graphics_270 = new cjs.Graphics().p('EgrlAAAMArlgrlMArmArlMgrmArmg');
    var mask_graphics_271 = new cjs.Graphics().p('EgsyAAAMAsygsyMAszAsyMgszAszg');
    var mask_graphics_272 = new cjs.Graphics().p('Egt+AAAMAt+gt+MAt/At+Mgt/At/g');
    var mask_graphics_273 = new cjs.Graphics().p('EgvIAAAMAvIgvIMAvJAvIMgvJAvJg');
    var mask_graphics_274 = new cjs.Graphics().p('EgwSAAAMAwSgwSMAwTAwSMgwTAwTg');
    var mask_graphics_275 = new cjs.Graphics().p('EgxaAAAMAxagxaMAxbAxaMgxbAxbg');
    var mask_graphics_276 = new cjs.Graphics().p('EgyhAAAMAyhgyhMAyiAyhMgyiAyig');
    var mask_graphics_277 = new cjs.Graphics().p('EgznAAAMAzngznMAzoAznMgzoAzog');
    var mask_graphics_278 = new cjs.Graphics().p('Eg0sAAAMA0sg0sMA0tA0sMg0tA0tg');
    var mask_graphics_279 = new cjs.Graphics().p('Eg1wAAAMA1wg1wMA1xA1wMg1xA1xg');
    var mask_graphics_280 = new cjs.Graphics().p('Eg2yAAAMA2yg2yMA2zA2yMg2zA2zg');
    var mask_graphics_281 = new cjs.Graphics().p('Eg30AAAMA30g30MA31A30Mg31A31g');
    var mask_graphics_282 = new cjs.Graphics().p('Eg40AAAMA40g40MA41A40Mg41A41g');
    var mask_graphics_283 = new cjs.Graphics().p('Eg50AAAMA50g50MA51A50Mg51A51g');
    var mask_graphics_284 = new cjs.Graphics().p('Eg6yAAAMA6yg6yMA6zA6yMg6zA6zg');
    var mask_graphics_285 = new cjs.Graphics().p('Eg7vAAAMA7vg7vMA7wA7vMg7wA7wg');
    var mask_graphics_286 = new cjs.Graphics().p('Eg8rAAAMA8rg8rMA8sA8rMg8sA8sg');
    var mask_graphics_287 = new cjs.Graphics().p('Eg9mAAAMA9mg9mMA9nA9mMg9nA9ng');
    var mask_graphics_288 = new cjs.Graphics().p('Eg+fAAAMA+fg+fMA+gA+fMg+gA+gg');
    var mask_graphics_289 = new cjs.Graphics().p('Eg/YAAAMA/Yg/YMA/ZA/YMg/ZA/Zg');
    var mask_graphics_290 = new cjs.Graphics().p('EhAPAAAMBAPhAPMBAQBAPMhAQBAQg');
    var mask_graphics_291 = new cjs.Graphics().p('EhBGAAAMBBGhBGMBBHBBGMhBHBBHg');
    var mask_graphics_292 = new cjs.Graphics().p('EhB7AAAMBB7hB7MBB8BB7MhB8BB8g');
    var mask_graphics_293 = new cjs.Graphics().p('EhCvAAAMBCvhCvMBCwBCvMhCwBCwg');
    var mask_graphics_294 = new cjs.Graphics().p('EhDiAAAMBDihDiMBDjBDiMhDjBDjg');
    var mask_graphics_295 = new cjs.Graphics().p('EhEUAAAMBEUhEUMBEVBEUMhEVBEVg');
    var mask_graphics_296 = new cjs.Graphics().p('EhFFAAAMBFFhFFMBFGBFFMhFGBFGg');
    var mask_graphics_297 = new cjs.Graphics().p('EhF0AAAMBF0hF0MBF1BF0MhF1BF1g');
    var mask_graphics_298 = new cjs.Graphics().p('EhGjAAAMBGjhGjMBGkBGjMhGkBGkg');
    var mask_graphics_299 = new cjs.Graphics().p('EhHQAAAMBHQhHQMBHRBHQMhHRBHRg');
    var mask_graphics_300 = new cjs.Graphics().p('EhH8AAAMBH8hH8MBH9BH8MhH9BH9g');
    var mask_graphics_301 = new cjs.Graphics().p('EhIoAAAMBIohIoMBIpBIoMhIpBIpg');
    var mask_graphics_302 = new cjs.Graphics().p('EhJSAAAMBJShJSMBJTBJSMhJTBJTg');
    var mask_graphics_303 = new cjs.Graphics().p('EhJ6AAAMBJ6hJ6MBJ7BJ6MhJ7BJ7g');
    var mask_graphics_304 = new cjs.Graphics().p('EhKiAAAMBKihKiMBKjBKiMhKjBKjg');
    var mask_graphics_305 = new cjs.Graphics().p('EhLJAAAMBLJhLJMBLKBLJMhLKBLKg');
    var mask_graphics_306 = new cjs.Graphics().p('EhLuAAAMBLuhLuMBLvBLuMhLvBLvg');
    var mask_graphics_307 = new cjs.Graphics().p('EhMTAAAMBMThMTMBMUBMTMhMUBMUg');
    var mask_graphics_308 = new cjs.Graphics().p('EhM2AAAMBM2hM2MBM3BM2MhM3BM3g');
    var mask_graphics_309 = new cjs.Graphics().p('EhNYAAAMBNYhNYMBNZBNYMhNZBNZg');
    var mask_graphics_310 = new cjs.Graphics().p('EhN5AAAMBN5hN5MBN6BN5MhN6BN6g');
    var mask_graphics_311 = new cjs.Graphics().p('EhOZAAAMBOZhOZMBOaBOZMhOaBOag');
    var mask_graphics_312 = new cjs.Graphics().p('EhO4AAAMBO4hO4MBO5BO4MhO5BO5g');
    var mask_graphics_313 = new cjs.Graphics().p('EhPWAAAMBPWhPWMBPXBPWMhPXBPXg');
    var mask_graphics_314 = new cjs.Graphics().p('EhPyAAAMBPyhPyMBPzBPyMhPzBPzg');
    var mask_graphics_315 = new cjs.Graphics().p('EhQOAAAMBQOhQOMBQPBQOMhQPBQPg');
    var mask_graphics_316 = new cjs.Graphics().p('EhQoAAAMBQohQoMBQpBQoMhQpBQpg');
    var mask_graphics_317 = new cjs.Graphics().p('EhRBAAAMBRBhRBMBRCBRBMhRCBRCg');
    var mask_graphics_318 = new cjs.Graphics().p('EhRZAAAMBRZhRZMBRaBRZMhRaBRag');
    var mask_graphics_319 = new cjs.Graphics().p('EhRwAAAMBRwhRwMBRxBRwMhRxBRxg');
    var mask_graphics_320 = new cjs.Graphics().p('EhSGAAAMBSGhSGMBSHBSGMhSHBSHg');
    var mask_graphics_321 = new cjs.Graphics().p('EhSbAAAMBSbhSbMBScBSbMhScBScg');
    var mask_graphics_322 = new cjs.Graphics().p('EhSvAAAMBSvhSvMBSwBSvMhSwBSwg');
    var mask_graphics_323 = new cjs.Graphics().p('EhTBAAAMBTBhTBMBTCBTBMhTCBTCg');
    var mask_graphics_324 = new cjs.Graphics().p('EhTSAAAMBTShTSMBTTBTSMhTTBTTg');
    var mask_graphics_325 = new cjs.Graphics().p('EhTjAAAMBTjhTjMBTkBTjMhTkBTkg');
    var mask_graphics_326 = new cjs.Graphics().p('EhTyAAAMBTyhTyMBTzBTyMhTzBTzg');
    var mask_graphics_327 = new cjs.Graphics().p('EhUAAAAMBUAhUAMBUBBUAMhUBBUBg');
    var mask_graphics_328 = new cjs.Graphics().p('EhUNAAAMBUNhUNMBUOBUNMhUOBUOg');
    var mask_graphics_329 = new cjs.Graphics().p('EhUYAAAMBUYhUYMBUZBUYMhUZBUZg');
    var mask_graphics_330 = new cjs.Graphics().p('EhUjAAAMBUjhUjMBUkBUjMhUkBUkg');
    var mask_graphics_331 = new cjs.Graphics().p('EhUtAAAMBUthUtMBUuBUtMhUuBUug');
    var mask_graphics_332 = new cjs.Graphics().p('EhU1AAAMBU1hU1MBU2BU1MhU2BU2g');
    var mask_graphics_333 = new cjs.Graphics().p('EhU8AAAMBU8hU8MBU9BU8MhU9BU9g');
    var mask_graphics_334 = new cjs.Graphics().p('EhVCAAAMBVChVCMBVDBVCMhVDBVDg');
    var mask_graphics_335 = new cjs.Graphics().p('EhVIAAAMBVIhVIMBVJBVIMhVJBVJg');
    var mask_graphics_336 = new cjs.Graphics().p('EhVLAAAMBVLhVLMBVMBVLMhVMBVMg');
    var mask_graphics_337 = new cjs.Graphics().p('EhVOAAAMBVOhVOMBVPBVOMhVPBVPg');
    var mask_graphics_338 = new cjs.Graphics().p('EhVQAAAMBVQhVQMBVRBVQMhVRBVRg');
    var mask_graphics_339 = new cjs.Graphics().p('EhVQAAAMBVQhVRMBVRBVRMhVRBVSg');

    this.timeline.addTween(
      cjs.Tween.get(mask)
        .to({ graphics: null, x: 0, y: 0 })
        .wait(247)
        .to({ graphics: mask_graphics_247, x: -1.5, y: -70.5 })
        .wait(1)
        .to({ graphics: mask_graphics_248, x: -1.6, y: -70.6 })
        .wait(1)
        .to({ graphics: mask_graphics_249, x: -1.6, y: -70.6 })
        .wait(1)
        .to({ graphics: mask_graphics_250, x: -1.6, y: -70.7 })
        .wait(1)
        .to({ graphics: mask_graphics_251, x: -1.6, y: -70.7 })
        .wait(1)
        .to({ graphics: mask_graphics_252, x: -1.7, y: -70.7 })
        .wait(1)
        .to({ graphics: mask_graphics_253, x: -1.7, y: -70.8 })
        .wait(1)
        .to({ graphics: mask_graphics_254, x: -1.7, y: -70.8 })
        .wait(1)
        .to({ graphics: mask_graphics_255, x: -1.7, y: -70.8 })
        .wait(1)
        .to({ graphics: mask_graphics_256, x: -1.7, y: -70.9 })
        .wait(1)
        .to({ graphics: mask_graphics_257, x: -1.8, y: -70.9 })
        .wait(1)
        .to({ graphics: mask_graphics_258, x: -1.8, y: -70.9 })
        .wait(1)
        .to({ graphics: mask_graphics_259, x: -1.8, y: -71 })
        .wait(1)
        .to({ graphics: mask_graphics_260, x: -1.8, y: -71 })
        .wait(1)
        .to({ graphics: mask_graphics_261, x: -1.8, y: -71 })
        .wait(1)
        .to({ graphics: mask_graphics_262, x: -1.8, y: -71 })
        .wait(1)
        .to({ graphics: mask_graphics_263, x: -1.9, y: -71.1 })
        .wait(1)
        .to({ graphics: mask_graphics_264, x: -1.9, y: -71.1 })
        .wait(1)
        .to({ graphics: mask_graphics_265, x: -1.9, y: -71.1 })
        .wait(1)
        .to({ graphics: mask_graphics_266, x: -1.9, y: -71.2 })
        .wait(1)
        .to({ graphics: mask_graphics_267, x: -1.9, y: -71.2 })
        .wait(1)
        .to({ graphics: mask_graphics_268, x: -2, y: -71.2 })
        .wait(1)
        .to({ graphics: mask_graphics_269, x: -2, y: -71.2 })
        .wait(1)
        .to({ graphics: mask_graphics_270, x: -2, y: -71.3 })
        .wait(1)
        .to({ graphics: mask_graphics_271, x: -2, y: -71.3 })
        .wait(1)
        .to({ graphics: mask_graphics_272, x: -2, y: -71.3 })
        .wait(1)
        .to({ graphics: mask_graphics_273, x: -2, y: -71.4 })
        .wait(1)
        .to({ graphics: mask_graphics_274, x: -2.1, y: -71.4 })
        .wait(1)
        .to({ graphics: mask_graphics_275, x: -2.1, y: -71.4 })
        .wait(1)
        .to({ graphics: mask_graphics_276, x: -2.1, y: -71.4 })
        .wait(1)
        .to({ graphics: mask_graphics_277, x: -2.1, y: -71.5 })
        .wait(1)
        .to({ graphics: mask_graphics_278, x: -2.1, y: -71.5 })
        .wait(1)
        .to({ graphics: mask_graphics_279, x: -2.1, y: -71.5 })
        .wait(1)
        .to({ graphics: mask_graphics_280, x: -2.1, y: -71.5 })
        .wait(1)
        .to({ graphics: mask_graphics_281, x: -2.2, y: -71.5 })
        .wait(1)
        .to({ graphics: mask_graphics_282, x: -2.2, y: -71.6 })
        .wait(1)
        .to({ graphics: mask_graphics_283, x: -2.2, y: -71.6 })
        .wait(1)
        .to({ graphics: mask_graphics_284, x: -2.2, y: -71.6 })
        .wait(1)
        .to({ graphics: mask_graphics_285, x: -2.2, y: -71.6 })
        .wait(1)
        .to({ graphics: mask_graphics_286, x: -2.2, y: -71.7 })
        .wait(1)
        .to({ graphics: mask_graphics_287, x: -2.2, y: -71.7 })
        .wait(1)
        .to({ graphics: mask_graphics_288, x: -2.2, y: -71.7 })
        .wait(1)
        .to({ graphics: mask_graphics_289, x: -2.3, y: -71.7 })
        .wait(1)
        .to({ graphics: mask_graphics_290, x: -2.3, y: -71.7 })
        .wait(1)
        .to({ graphics: mask_graphics_291, x: -2.3, y: -71.8 })
        .wait(1)
        .to({ graphics: mask_graphics_292, x: -2.3, y: -71.8 })
        .wait(1)
        .to({ graphics: mask_graphics_293, x: -2.3, y: -71.8 })
        .wait(1)
        .to({ graphics: mask_graphics_294, x: -2.3, y: -71.8 })
        .wait(1)
        .to({ graphics: mask_graphics_295, x: -2.3, y: -71.8 })
        .wait(1)
        .to({ graphics: mask_graphics_296, x: -2.3, y: -71.8 })
        .wait(1)
        .to({ graphics: mask_graphics_297, x: -2.3, y: -71.9 })
        .wait(1)
        .to({ graphics: mask_graphics_298, x: -2.4, y: -71.9 })
        .wait(1)
        .to({ graphics: mask_graphics_299, x: -2.4, y: -71.9 })
        .wait(1)
        .to({ graphics: mask_graphics_300, x: -2.4, y: -71.9 })
        .wait(1)
        .to({ graphics: mask_graphics_301, x: -2.4, y: -71.9 })
        .wait(1)
        .to({ graphics: mask_graphics_302, x: -2.4, y: -71.9 })
        .wait(1)
        .to({ graphics: mask_graphics_303, x: -2.4, y: -71.9 })
        .wait(1)
        .to({ graphics: mask_graphics_304, x: -2.4, y: -72 })
        .wait(1)
        .to({ graphics: mask_graphics_305, x: -2.4, y: -72 })
        .wait(1)
        .to({ graphics: mask_graphics_306, x: -2.4, y: -72 })
        .wait(1)
        .to({ graphics: mask_graphics_307, x: -2.4, y: -72 })
        .wait(1)
        .to({ graphics: mask_graphics_308, x: -2.4, y: -72 })
        .wait(1)
        .to({ graphics: mask_graphics_309, x: -2.4, y: -72 })
        .wait(1)
        .to({ graphics: mask_graphics_310, x: -2.5, y: -72 })
        .wait(1)
        .to({ graphics: mask_graphics_311, x: -2.5, y: -72 })
        .wait(1)
        .to({ graphics: mask_graphics_312, x: -2.5, y: -72.1 })
        .wait(1)
        .to({ graphics: mask_graphics_313, x: -2.5, y: -72.1 })
        .wait(1)
        .to({ graphics: mask_graphics_314, x: -2.5, y: -72.1 })
        .wait(1)
        .to({ graphics: mask_graphics_315, x: -2.5, y: -72.1 })
        .wait(1)
        .to({ graphics: mask_graphics_316, x: -2.5, y: -72.1 })
        .wait(1)
        .to({ graphics: mask_graphics_317, x: -2.5, y: -72.1 })
        .wait(1)
        .to({ graphics: mask_graphics_318, x: -2.5, y: -72.1 })
        .wait(1)
        .to({ graphics: mask_graphics_319, x: -2.5, y: -72.1 })
        .wait(1)
        .to({ graphics: mask_graphics_320, x: -2.5, y: -72.1 })
        .wait(1)
        .to({ graphics: mask_graphics_321, x: -2.5, y: -72.1 })
        .wait(1)
        .to({ graphics: mask_graphics_322, x: -2.5, y: -72.1 })
        .wait(1)
        .to({ graphics: mask_graphics_323, x: -2.5, y: -72.2 })
        .wait(1)
        .to({ graphics: mask_graphics_324, x: -2.5, y: -72.2 })
        .wait(1)
        .to({ graphics: mask_graphics_325, x: -2.5, y: -72.2 })
        .wait(1)
        .to({ graphics: mask_graphics_326, x: -2.5, y: -72.2 })
        .wait(1)
        .to({ graphics: mask_graphics_327, x: -2.5, y: -72.2 })
        .wait(1)
        .to({ graphics: mask_graphics_328, x: -2.5, y: -72.2 })
        .wait(1)
        .to({ graphics: mask_graphics_329, x: -2.5, y: -72.2 })
        .wait(1)
        .to({ graphics: mask_graphics_330, x: -2.5, y: -72.2 })
        .wait(1)
        .to({ graphics: mask_graphics_331, x: -2.5, y: -72.2 })
        .wait(1)
        .to({ graphics: mask_graphics_332, x: -2.5, y: -72.2 })
        .wait(1)
        .to({ graphics: mask_graphics_333, x: -2.5, y: -72.2 })
        .wait(1)
        .to({ graphics: mask_graphics_334, x: -2.5, y: -72.2 })
        .wait(1)
        .to({ graphics: mask_graphics_335, x: -2.5, y: -72.2 })
        .wait(1)
        .to({ graphics: mask_graphics_336, x: -2.5, y: -72.2 })
        .wait(1)
        .to({ graphics: mask_graphics_337, x: -2.5, y: -72.2 })
        .wait(1)
        .to({ graphics: mask_graphics_338, x: -2.5, y: -72.2 })
        .wait(1)
        .to({ graphics: mask_graphics_339, x: -1.4, y: -70.3 })
        .wait(104)
        .to({ graphics: null, x: 0, y: 0 })
        .wait(520)
    );
    ...
    this.instance.parent = this;
    this.instance.setTransform(19.6, -13.7, 1.123, 0.414, 0, 0, 0, 17.9, 18);
    ...
    this.instance_1.parent = this;
    this.instance_1.setTransform(-5, -44.9, 0.8, 0.8, 0, 0, 0, 15, 15);
    ...
    this.instance_2.parent = this;
    this.instance_2.setTransform(13.5, 15.1, 1, 1, 0, 0, 0, 13.5, 13.5);
  ...
  // stage content:
  (lib._300_250 = function (mode, startPosition, loop) {
    this.initialize(mode, startPosition, loop, {});
    ...
    this.instance.parent = this;
    this.instance.setTransform(169.6, 140.3, 1.021, 0.893, 0, 0, 0, 17.2, 17.2);
    ...
    this.instance_1.parent = this;
    this.instance_1.setTransform(146.1, 24.9, 0.809, 0.809, 0, 0, 0, 104.3, 15.8);
    ...
    this.instance_2.parent = this;
    this.instance_2.setTransform(150, 38.4, 0.714, 0.714, 0, 0, 0, 150.1, 299.9);
    ...
    this.instance_3.parent = this;
    this.instance_3.setTransform(158.1, 145.6, 0.714, 0.714, 0, 0, 0, 12.1, 18.6);

    this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(1800));

    // Button
    this.instance_4 = new lib.Symbol56('synched', 0);
    this.instance_4.parent = this;
    this.instance_4.setTransform(158.1, 62.6, 0.714, 0.714, 0, 0, 0, 13.2, 13.2);
    ...
    this.instance_5.parent = this;
    this.instance_5.setTransform(158.6, 144.2, 0.714, 0.714, 0, 0, 0, 12.7, 12.7);

    this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(1800));

    // Txt
    this.instance_6 = new lib.Symbol40('synched', 0);
    this.instance_6.parent = this;
    this.instance_6.setTransform(163.4, 53.5, 0.714, 0.714, 0, 0, 0, 15.2, 15.2);

    this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(1800));

    // Gradient
    this.instance_7 = new lib.Symbol42('synched', 0);
    this.instance_7.parent = this;
    this.instance_7.setTransform(188.9, 144.2, 0.893, 0.893, 0, 0, 0, 21.6, 21.6);

    this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(1800));

    // Layer_9
    this.instance_8 = new lib.Symbol53('synched', 0);
    this.instance_8.parent = this;
    this.instance_8.setTransform(143.8, 289.9, 0.893, 0.893, 0, 0, 0, 26.2, 26.1);

    this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(1800));

    // Earth
    this.instance_9 = new lib.Symbol52('synched', 0);
    this.instance_9.parent = this;
    this.instance_9.setTransform(166.5, 52.3, 0.893, 0.893, 0, 0, 0, 12, 12.1);

    this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(1800));

    // Stars
    this.instance_10 = new lib.Symbol51('synched', 0);
    this.instance_10.parent = this;
    this.instance_10.setTransform(165.1, 138.4, 0.999, 0.893, 0, 0, 0, 15.2, 15.1);
    ...
    this.instance_11.parent = this;
    this.instance_11.setTransform(167.4, 187.1, 0.893, 0.893, 0, 0, 0, 19.6, 19.6);

    this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(1800));

    // Lights
    this.instance_12 = new lib.Symbol36('synched', 0);
    this.instance_12.parent = this;
    this.instance_12.setTransform(172.8, 141.6, 0.893, 0.893, 0, 0, 0, 25.6, 25.6);

    this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(1800));

    // Clouds
    this.instance_13 = new lib.Symbol35('synched', 0);
    this.instance_13.parent = this;
    this.instance_13.setTransform(169.2, 146.1, 0.893, 0.893, 0, 0, 0, 21.6, 21.6);

    this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(1800));

    // Plane
    this.instance_14 = new lib.Symbol34('synched', 0);
    this.instance_14.parent = this;
    this.instance_14.setTransform(169.7, 144.7, 0.893, 0.893, 0, 0, 0, 22.1, 22.1);

    this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(1800));

    // Town
    this.instance_15 = new lib.Symbol33('synched', 0);
    this.instance_15.parent = this;
    this.instance_15.setTransform(166.5, 141.5, 0.893, 0.893, 0, 0, 0, 18.6, 18.6);

    this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(1800));

    // BG
    this.shape = new cjs.Shape();
    this.shape.graphics.f('#101623').s().p('A3bTiMAAAgnDMAu3AAAMAAAAnDg');
    this.shape.setTransform(150, 125);

    this.timeline.addTween(cjs.Tween.get(this.shape).wait(1800));
  }).prototype = p = new cjs.MovieClip();
  p.nominalBounds = new cjs.Rectangle(143.7, -50.8, 312.5, 428.6);
  // library properties:
  lib.properties = {
